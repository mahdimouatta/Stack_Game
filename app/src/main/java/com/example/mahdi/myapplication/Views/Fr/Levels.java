...
public class Levels extends Screen {
    ...
    public Levels(Game game) {
        ...
        graphics.drawImage(Fr.lvls,0,0,graphics.getWidth(),graphics.getHeight());
        lvl1 = new ButtonUI(game, Fr.lvl1,Fr.lvl1, graphics.getWidth()/8,graphics.getHeight()*2/5, graphics.getHeight()/4,graphics.getWidth()/4);
        lvl2 = new ButtonUI(game, Fr.lvl2,Fr.lvl2, graphics.getWidth()*5/8,graphics.getHeight()*2/5, graphics.getHeight()/4,graphics.getWidth()/4);
