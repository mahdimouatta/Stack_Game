...
public class Levels extends Screen {
    ...
    public Levels(Game game) {
        ...
        graphics.drawImage(Ar.lvls,0,0,graphics.getWidth(),graphics.getHeight());
        lvl1 = new ButtonUI(game, Ar.lvl1,Ar.lvl1, graphics.getWidth()/8,graphics.getHeight()*2/5, graphics.getHeight()/4,graphics.getWidth()/4);
